            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              >
                <div className="relative group">
                  <div
                    className={`w-80 h-80 lg:w-96 lg:h-96 overflow-hidden shadow-2xl ${isDarkMode ? "border-2 border-red-500/30" : "border-2 border-red-500/20"} transition-all duration-700 ${!isMobile ? "group-hover:scale-105" : ""} ${isDarkMode ? "group-hover:border-red-400/60" : "group-hover:border-red-500/40"} rounded-lg`}
                  >
                    <Image
